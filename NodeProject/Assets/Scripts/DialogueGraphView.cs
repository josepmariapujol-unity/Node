...
public class DialogueGraphView : GraphView
{
    ...
    //private readonly string defaultNodeName = "Node";
    ...
    private Port GeneratePort(FloatNode node, Direction portDirection, Port.Capacity capacity = Port.Capacity.Single)
    {
